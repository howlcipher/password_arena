...
See [SECURITY.md](SECURITY.md) for the full policy, [docs/REPORTING.md](docs/REPORTING.md) for journal semantics, [docs/MODEL_PROVIDERS.md](docs/MODEL_PROVIDERS.md) for multi-model design, and [docs/ROADMAP.md](docs/ROADMAP.md) for planned delivery phases.
